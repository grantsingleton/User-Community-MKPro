...
import { Link } from 'react-router-dom' //gws 2/12/20

import styles from "../../Assets/infoStyleUpdated";
  ...
  return (
    <div className={infoAreaClasses}>
      ...
      <div className={classes.descriptionWrapper}>
        <Link to={'/choose-registration/'+title} className={classes.titleButton}>
